...
module.exports = function(grunt) {
    ...
    grunt.registerTask('build', ['lint:prod', 'sasslint', 'copy', 'uglify', 'version:all', 'sass', 'autoprefixer']);
    grunt.registerTask('release', ['lint:prod', 'sasslint', 'test', 'shell:tagRelease']);
